...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("MyBitcoinClassic-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("MyBitcoinClassic-net");
...
static const char *strDNSSeed[][2] = {
    {"crawl.mybitcoinclassic.org", "crawl.mybitcoinclassic.org"},
	{"node.mybitcoinclassic.org", "node.mybitcoinclassic.org"},
	{"chain.mybitcoinclassic.org", "chain.mybitcoinclassic.org"},
	{"vault.mybitcoinclassic.org", "vault.mybitcoinclassic.org"}
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("MyBitcoinClassic-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("MyBitcoinClassic-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("MyBitcoinClassic-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("MyBitcoinClassic-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. MyBitcoinClassic is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("MyBitcoinClassic-start");
