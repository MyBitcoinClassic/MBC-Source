...
unsigned int nStakeMinAge = 8 * nOneHour; // 8 hrs as zero time weight
unsigned int nStakeMaxAge = 3 * 24 * nOneHour; // 90 days as full weight
...
const string strMessageMagic = "MyBitcoinClassic Signed Message:\n";
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("MyBitcoinClassic-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in MyBitcoinClassic
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // MyBitcoinClassic: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MyBitcoinClassic", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "MBC Genesis";
        CTransaction txNew;
        ...
        block.nNonce   = 675434; // !fTestNet ? 1575379 : 46534;
		
       
        block.print();

        //// debug print
        assert(block.hashMerkleRoot == uint256("0x1894de34af5868441464dc0166b27821280e7495356c45ec09b2082c5aed4b28"));
...
unsigned char pchMessageStart[4] = { 0xb4, 0xfc, 0xec, 0xe5 };
