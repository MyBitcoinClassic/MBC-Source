    ...
    optionsDialog(0)
{
    ...
    setWindowTitle(tr("MyBitcoinClassic") + " - " + tr("Wallet"));
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a MyBitcoinClassic address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About MyBitcoinClassic"), this);
    aboutAction->setStatusTip(tr("Show information about MyBitcoinClassic"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MyBitcoinClassic"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MyBitcoinClassic addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MyBitcoinClassic addresses"));
    secondAuthAction = new QAction(QIcon(":/icons/key"), tr("Second &auth..."), this);
    secondAuthAction->setStatusTip(tr("Second auth with your MyBitcoinClassic addresses"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("MyBitcoinClassic client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("MyBitcoinClassic client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MyBitcoinClassic network", "", count));
}
...
{
    QString strTitle = tr("MyBitcoinClassic") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid MyBitcoinClassic address or malformed URI parameters."));
    }
